    ...
    <div data-testid="data-entry-page" className="h-[calc(100vh-64px)]">
      ...
      <div
        ...
        style={{
          ...
          ['--tw-gradient-from' as any]: darkerColor,
          ['--tw-gradient-to' as any]: headerColor,
        }}
      >
        <style>{`
          @media (prefers-color-scheme: dark) {
            .dark div[style*="--tw-gradient-from"] {
              --tw-gradient-from: ${darkerColorDark} !important;
              --tw-gradient-to: ${headerColorDark} !important;
            }
          }
        `}</style>
        {/* Breadcrumb */}
