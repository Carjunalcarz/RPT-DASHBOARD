  ...
  return (
    <div data-testid="order-of-payment-page" className="space-y-6 p-6">
      <div
        ...
        style={{ background: `linear-gradient(to right, ${headerColor}, ${headerColor}dd)` }}
      >
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h1 className="text-xl font-bold text-white">Order of Payment</h1>
            <p className="text-blue-100 text-sm mt-1">Generate a printable payment order from assessment records</p>
          </div>
          <div className="flex flex-wrap gap-2">
            ...
            <button
              ...
              disabled={!canPrint}
              className="flex items-center gap-2 px-3 py-1.5 bg-white text-slate-900 hover:bg-blue-50 rounded-lg transition-colors text-sm font-medium shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
            ...
            <div className="p-4 border-b border-slate-200 dark:border-slate-700 flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 w-full">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleFilterChange}
                    className="w-full px-3 py-2 bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-700 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 h-[40px]"
                  >
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md flex items-center gap-2 transition-colors text-sm font-medium h-[40px]"
                >
                  <Filter size={16} />
                  Apply
                </button>
              ...
              <div className="flex items-center gap-2 w-full sm:w-auto">
                <div className="relative w-full sm:w-80">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-2 bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-700 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                  ...
                  {loading ? (
                    ...
                    visibleRecords.map((r) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 text-right whitespace-nowrap font-medium text-blue-600 dark:text-blue-400">
            ...
            <div className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-700 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 font-mono"
                />
              </div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow p-4">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="pt-3 border-t border-slate-200 dark:border-slate-700 flex justify-between">
                ...
                <span className="font-bold text-blue-600 dark:text-blue-400">{formatCurrency(totals.grandTotal)}</span>
              </div>
            </div>
            <div className="mt-4 grid grid-cols-1 gap-2">
              <button
                ...
                className="w-full px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md transition-colors text-sm font-semibold disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
          ...
          <div style={{ padding: 24, fontFamily: 'Arial, sans-serif' }}>
            ...
            <div style={{ marginTop: 16 }}>
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 11 }}>
                ...
                <tbody>
                  {computedRows.map(({ record, basicTax, penalty, fees, total }) => (
