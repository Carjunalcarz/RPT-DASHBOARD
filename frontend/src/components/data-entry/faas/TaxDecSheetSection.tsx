    ...
    <div className="bg-white dark:bg-slate-900 rounded-lg shadow-sm border border-slate-200 dark:border-slate-800">
      ...
      <div className="p-6">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2 ml-6">
              ...
              <input
                ...
                className="px-2 py-1 text-xs bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded focus:outline-none focus:ring-1 focus:ring-blue-500 disabled:opacity-50"
            ...
            <div className="flex items-center gap-2 ml-6">
              ...
              <select className="px-2 py-1 text-xs bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded focus:outline-none focus:ring-1 focus:ring-blue-500">
                <option value=""></option>
              </select>
            </div>
        ...
        <div className="flex justify-center gap-3">
          <button
            onClick={handlePrint}
            className="px-6 py-2 text-sm bg-blue-600 hover:bg-blue-700 text-white rounded shadow-sm transition-colors flex items-center gap-2"
          >
            <Printer size={14} />
            Print
          </button>
