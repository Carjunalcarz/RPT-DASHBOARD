    ...
    <div className="flex gap-2">
      ...
      {pdfEndpoint && (
          <button
            ...
            className="px-3 py-2 text-xs bg-blue-600 hover:bg-blue-700 text-white rounded-lg shadow-sm transition-colors flex items-center gap-1.5 disabled:opacity-50"
