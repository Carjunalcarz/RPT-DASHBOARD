...
const rptAssController = require('../controllers/rptAssController');
 ...
 */
router.get('/', protect, rptAssController.getAll);
 ...
 */
router.get('/:id', protect, rptAssController.getById);
 ...
 */
router.post('/', protect, validate(createValidation), rptAssController.create);
 ...
 */
router.put('/:id', protect, validate(updateValidation), rptAssController.update);
 ...
 */
router.delete('/:id', protect, rptAssController.delete);
