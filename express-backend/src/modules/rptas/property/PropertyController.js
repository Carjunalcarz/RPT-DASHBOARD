...
class PropertyController {
  ...
  async getAgusanMigrationData(req, res, next) {
    try {
      ...
      const result = await this.propertyService.getAgusanMigrationData({ 
        page, 
        limit, 
        searchField, 
        filterValue,
  ...
  async updateSignatory(req, res, next) {
    try {
      ...
      const result = await this.propertyService.updateSignatory(tdn, data);
  ...
  async getMastExtn(req, res, next) {
    try {
      const { tdn } = req.params;
      const data = await this.propertyService.getMastExtn(tdn);
