...
class AssessmentService {
  ...
  async getAll({ page = 1, limit = 100, sortBy = 'TDN', sortOrder = 'ASC', filters = {} }) {
    try {
      ...
      this.logger.info(`Executing RPT_ASS getAll query`);
      ...
      this.logger.error('Error in RptAssService.getAll:', error);
  ...
  async getById(id) {
    try {
      ...
      this.logger.error('Error in RptAssService.getById:', error);
      throw new AppError('Database query failed', 500);
    }
  }
  ...
  async create(data) {
    try {
      ...
      this.logger.error('Error in RptAssService.create:', error);
  ...
  async update(id, data) {
    try {
      ...
      if (error instanceof AppError) throw error;
      this.logger.error('Error in RptAssService.update:', error);
  ...
  async delete(id, userId) {
    try {
      ...
      if (error instanceof AppError) throw error;
      this.logger.error('Error in RptAssService.delete:', error);
