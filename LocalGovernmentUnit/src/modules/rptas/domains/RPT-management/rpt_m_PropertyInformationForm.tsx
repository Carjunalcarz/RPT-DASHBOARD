...
const PropertyInformationForm: React.FC = () => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="mb-6">
      ...
      <div className="bg-surface dark:bg-surface rounded-lg shadow-sm border border-border dark:border-border overflow-hidden mb-4">
        <div className="bg-primary dark:bg-primary/100 px-4 py-3">
          <h3 className="text-base font-semibold text-surface">Property Information</h3>
        </div>
        <div className="p-4">
      ...
      <div className="bg-surface dark:bg-surface rounded-lg shadow-sm border border-border dark:border-border overflow-hidden mb-4">
        <div className="bg-primary dark:bg-primary/100 px-4 py-3">
          <h3 className="text-base font-semibold text-surface">Property Owner and Administrator</h3>
        </div>
        <div className="p-4">
      ...
      <div className="bg-surface dark:bg-surface rounded-lg shadow-sm border border-border dark:border-border overflow-hidden mb-4">
        <div className="bg-primary dark:bg-primary/100 px-4 py-3">
          <h3 className="text-base font-semibold text-surface">Property Boundaries</h3>
        </div>
        <div className="p-4">
      ...
      <div className="flex justify-end gap-3">
        ...
        <button
          type="submit"
          className="px-4 py-2 text-sm bg-primary hover:bg-primary-light dark:bg-primary/100 dark:hover:bg-primary text-surface rounded-lg transition-colors font-medium"
        >
