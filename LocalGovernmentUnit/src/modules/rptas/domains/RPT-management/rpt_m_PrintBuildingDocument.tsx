  ...
  const renderChecklistRow = (label: string, value: string, options: string[]) => {
    return (
      <tr className="text-[7pt]">
        <td className="border-r border-border px-1 font-medium">{label}</td>
        {options.map((opt, idx) => (
          <td key={idx} className="border-r border-border px-1 text-center">
            {value === opt ? 'X' : ''}
          </td>
        ))}
    ...
    <div id="print-document" className="print-faas-official">
      ...
      <div className="faas-page faas-page-front">
        <div className="faas-border-inner">
          ...
          {/* Form Header */}
          <div className="faas-header bg-surface text-black border-y-2 border-black print:bg-surface print:text-black">
          ...
          <div className="faas-section-header bg-surface text-black font-bold border-t border-b border-black">BUILDING LOCATION</div>
          <div className="faas-row border-b">
          ...
          {/* Land Reference */}
          <div className="faas-section-header bg-surface text-black font-bold border-t border-b border-black">LAND REFERENCE</div>
          <div className="faas-row border-b">
          ...
          <div className="bg-surface text-black font-bold text-[9pt] px-2 py-0.5 border-t border-b border-black">GENERAL DESCRIPTION</div>
          ...
          <div className="faas-row border-b border-black">
             ...
             <div className="faas-col faas-col-5 p-0 border-r border-black">
                <div className="bg-surface text-black px-1 py-0.5 text-[7pt] font-bold border-b border-black uppercase">
                   BUILDING IDENTIFICATION & PERMIT INFO
                </div>
                
                {/* Grid Rows */}
                <div className="grid grid-cols-[140px_1fr] border-b border-border">
                   <div className="bg-surface px-1 py-1 text-[6pt] font-bold text-foreground flex items-center">KIND OF BLDG.</div>
                   <div className="px-1 py-1 text-[7pt] text-muted">{mainStruc.Actual_use || mainStruc.KIND || ''}</div>
                </div>
                <div className="grid grid-cols-[140px_1fr] border-b border-border">
                   <div className="bg-surface px-1 py-1 text-[6pt] font-bold text-foreground flex items-center">STRUCTURAL TYPE</div>
                   <div className="px-1 py-1 text-[7pt] text-foreground leading-tight">{mainStruc.Struc_type || ''}</div>
                </div>
                <div className="grid grid-cols-[140px_1fr] border-b border-border">
                   <div className="bg-surface px-1 py-1 text-[6pt] font-bold text-foreground flex items-center">BLDG. PERMIT NO.</div>
                   <div className="px-1 py-1 text-[7pt] text-foreground">{mainStruc.Bldg_Permit || ''}</div>
                </div>
                <div className="grid grid-cols-[140px_1fr] border-b border-border">
                   <div className="bg-surface px-1 py-1 text-[6pt] font-bold text-foreground flex items-center leading-tight">CONDOMINIUM CERTIFICATE OF TITLE (CCT)</div>
                   <div className="px-1 py-1 text-[7pt] text-foreground flex items-center">{mainStruc.Sub_Tdn || ''}</div>
                </div>
                <div className="grid grid-cols-[140px_1fr] border-b border-border">
                   <div className="bg-surface px-1 py-1 text-[6pt] font-bold text-foreground flex items-center leading-tight">CERTIFICATE OF COMPLETION (ISSUED ON:)</div>
                   <div className="px-1 py-1 text-[7pt] text-foreground flex items-center justify-between">
                      {formatDate(mainStruc.C_complete || mainStruc.D_complete || '')}
                      <Calendar size={10} className="text-muted" />
                   </div>
                </div>
                <div className="grid grid-cols-[140px_1fr]">
                   <div className="bg-surface px-1 py-1 text-[6pt] font-bold text-foreground flex items-center leading-tight">CERTIFICATE OF OCCUPANCY (ISSUED ON:)</div>
                   <div className="px-1 py-1 text-[7pt] text-foreground flex items-center justify-between">
             ...
             <div className="faas-col faas-col-4 p-0 border-r border-black">
                ...
                <div className="grid grid-cols-[100px_1fr] border-b border-border">
                   <div className="bg-surface px-1 py-1 text-[6pt] font-bold text-foreground flex items-center">BLDG. AGE</div>
                   <div className="px-1 py-1 text-[8pt] text-foreground text-center font-medium">{mainStruc.Age ? `${mainStruc.Age} Years` : ''}</div>
                </div>
                <div className="grid grid-cols-[100px_1fr] border-b border-border">
                   <div className="bg-surface px-1 py-1 text-[6pt] font-bold text-foreground flex items-center">NO. OF STOREYS</div>
                   <div className="px-1 py-1 text-[8pt] text-foreground text-center font-medium flex justify-between items-center pl-4">
                      {mainStruc.Storey || ''}
                      <div className="bg-surface border border-border rounded px-0.5">
                         <ArrowUpDown size={8} className="text-muted" />
                      </div>
                   </div>
                </div>
                <div className="grid grid-cols-[100px_1fr] border-b border-border">
                   <div className="bg-surface px-1 py-1 text-[6pt] font-bold text-foreground flex items-center">AREA OF 1ST FLR.</div>
                   <div className="px-1 py-1 text-[8pt] text-foreground text-center font-medium">{mainStruc.FirstFloor ? `${mainStruc.FirstFloor} sq.ft.` : ''}</div>
                </div>
                <div className="grid grid-cols-[100px_1fr] border-b border-border">
                   <div className="bg-surface px-1 py-1 text-[6pt] font-bold text-foreground flex items-center">AREA OF 2ND FLR.</div>
                   <div className="px-1 py-1 text-[8pt] text-foreground text-center font-medium">{mainStruc.SecondFloor ? `${mainStruc.SecondFloor} sq.ft.` : ''}</div>
                </div>
                <div className="grid grid-cols-[100px_1fr] border-b border-border">
                   <div className="bg-surface px-1 py-1 text-[6pt] font-bold text-foreground flex items-center">AREA OF 3RD FLR.</div>
                   <div className="px-1 py-1 text-[8pt] text-foreground text-center font-medium">{mainStruc.ThirdFloor ? `${mainStruc.ThirdFloor} sq.ft.` : ''}</div>
                </div>
                <div className="grid grid-cols-[100px_1fr]">
                   <div className="bg-surface px-1 py-1 text-[6pt] font-bold text-foreground flex items-center">AREA OF 4TH FLR.</div>
                   <div className="px-1 py-1 text-[8pt] text-foreground text-center font-medium">{mainStruc.Others ? `${mainStruc.Others} sq.ft.` : ''}</div>
                </div>
             </div>
             
             {/* Column 3: FLOOR PLAN REFERENCE */}
             <div className="faas-col faas-col-3 p-0 relative flex flex-col">
                <div className="bg-surface text-black border-b border-black px-1 py-0.5">
                ...
                <div className="flex-grow p-2 flex items-center justify-center">
                   ...
                   <div className="w-full h-24 border border-border bg-background flex items-center justify-center">
                      <span className="text-[6pt] text-muted">Floor Plan Image</span>
                   </div>
                </div>
                <div className="flex border-t border-border">
                   <div className="bg-surface px-1 py-0.5 text-[5pt] font-bold border-r border-border">PLAN FILENAME</div>
          ...
          <div className="faas-row border-b border-black">
             <div className="faas-col faas-col-12 p-0">
                <div className="bg-surface text-black border-b border-border px-1 py-0.5">
                   <span className="text-[6pt] font-bold">SUMMARY & TOTALS</span>
                </div>
                <div className="flex">
                   <div className="w-1/3 border-r border-border px-2 py-1 flex items-center justify-between">
                      <span className="text-[6pt] font-bold text-foreground">DATE CONSTRUCTED/COMPLETED:</span>
                      <span className="text-[8pt] font-bold text-black">{formatDate(mainStruc.D_construct || '')}</span>
                   </div>
                   <div className="w-1/3 border-r border-border px-2 py-1 flex items-center justify-between">
                      <span className="text-[6pt] font-bold text-foreground">DATE OCCUPIED:</span>
                   ...
                   <div className="w-1/3 px-2 py-1 flex flex-col justify-center relative">
                      <span className="text-[6pt] font-bold text-foreground">TOTAL FLOOR AREA:</span>
                      <span className="text-[12pt] font-bold text-black leading-none">{mainStruc.Total_Area || mainStruc.Floor_area || '0'} sq.ft.</span>
                      <div className="absolute bottom-0 right-1 text-muted">
          ...
          <div className="faas-section-header bg-surface text-black font-bold border-t border-b border-black">STRUCTURAL MATERIALS (CHECKLISTS)</div>
          
          <div className="flex border-b border-black text-[7pt]">
             {/* Foundation */}
             <div className="w-1/4 border-r border-black">
                <div className="bg-surface font-bold px-1 py-0.5 border-b border-black flex justify-between items-center">
                ...
                <div className="p-1 space-y-1">
                   {['Steel', 'Reinforced Concrete', 'Plain Concrete'].map(item => (
                      <div key={item} className="flex justify-between items-center">
                         <span>{item}</span>
                         <div className="w-3 h-3 border border-slate-500 flex items-center justify-center bg-surface">
             ...
             <div className="w-[37.5%] border-r border-black flex flex-col">
                ...
                <div className="flex-grow">
                   {['Reinforced Concrete', 'Plain Cement', 'Marble', 'Wood', 'Tiles'].map((item, idx) => (
                      <div key={idx} className={`flex items-center h-5 border-b border-border ${idx % 2 === 0 ? 'bg-surface' : ''}`}>
                   ...
                   <div className="flex items-center h-5 mt-auto mb-1">
                      ...
                      <div className="flex gap-1 pr-1">
                         {[1, 2, 3, 4].map(floor => (
                            <div key={floor} className="w-5 flex justify-center">
                               <div className="w-3 h-3 border border-slate-500 flex items-center justify-center bg-surface"></div>
                            </div>
                         ))}
                      </div>
                   </div>
             ...
             <div className="flex justify-between items-start">
                ...
                <div className="flex-1 max-w-[45%]">
                   ...
                   <div className="flex gap-4 text-[7pt] mt-1 pl-4">
                      <div className="flex-1 text-center italic text-foreground">MUNICIPAL ASSESSOR</div>
                      <div className="w-24 text-center">Date</div>
                   </div>
                </div>
             </div>
