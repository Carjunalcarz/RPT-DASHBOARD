        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-1">
            ...
            <button
              ...
              disabled={!selectedRecord || isLocalFormEnabled || !isFormEnabled}
              className="px-2 py-1 text-xs bg-surface dark:bg-muted/20 hover:bg-danger/10 dark:hover:bg-red-900/20 border border-border dark:border-border rounded shadow-sm transition-colors flex items-center gap-1 text-danger dark:text-danger disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <Trash2 size={12} />
              Delete
            </button>
          ...
          {/* Adjustment Table */}
          <div className="overflow-x-auto border border-border dark:border-border rounded h-40">
            <table className="w-full text-xs">
              <thead className="bg-orange-600 dark:bg-orange-700 text-surface sticky top-0">
                <tr>
              ...
              <tbody className="divide-y divide-slate-200 dark:divide-slate-700">
                {records.length === 0 ? (
                  <tr>
                    <td colSpan={8} className="px-3 py-6 text-center text-muted dark:text-muted">
                    ...
                    <tr
                      ...
                      className={`cursor-pointer transition-colors ${
                        selectedRecord?.SeqNo === record.SeqNo
                          ? 'bg-warning/20 dark:bg-orange-900/30'
                          : index % 2 === 0
                          ? 'bg-surface dark:bg-surface'
                          : 'bg-background dark:bg-background/50'
                      } hover:bg-warning/10 dark:hover:bg-orange-900/20`}
                    >
          ...
          {/* Form Section */}
          <div className={`bg-muted/10 dark:bg-background border border-border dark:border-border rounded p-3 ${!isLocalFormEnabled ? 'opacity-50 pointer-events-none' : ''}`}>
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center">
                  ...
                  <input 
                    ...
                    disabled={!isLocalFormEnabled}
                    className="w-24 px-2 py-1 text-xs border rounded text-right bg-background"
                    readOnly
                  />
                </div>
                <div className="flex items-center">
