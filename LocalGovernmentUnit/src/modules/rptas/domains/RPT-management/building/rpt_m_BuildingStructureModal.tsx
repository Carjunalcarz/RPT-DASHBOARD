...
const BuildingStructureModal: React.FC<BuildingStructureModalProps> = ({ 
  ...
  const handleRowSelect = (record: BldgStrucRecord) => {
    ...
    setFormData({
      ...
      structureType: pickString((record as any).Struc_type, (record as any).STRUC_TYPE, (record as any).Actual_use, (record as any).ACTUAL_USE, parentStructureType),
                ...
                <div className="flex items-center">
                  ...
                  <div className="flex-1 flex gap-1">
                    ...
                    <input 
                      ...
                      disabled={!isLocalFormEnabled}
                      className="flex-1 px-2 py-1 text-xs border rounded text-right bg-background"
