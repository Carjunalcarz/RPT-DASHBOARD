  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="text-xl font-semibold text-foreground dark:text-surface">Signatories List</h2>
          <p className="text-sm text-muted dark:text-muted">Manage individual officials and staff.</p>
        </div>
              ...
              <TableBody>
                {loading ? (
                  ...
                  signatories.map((signatory) => (
                    <TableRow key={signatory.id} className="hover:bg-muted/5/50 dark:hover:bg-muted/10/50 transition-colors">
                      <TableCell>
                        <div className="flex flex-col">
                          <span className="font-medium text-foreground dark:text-surface">{signatory.name}</span>
                          <span className="text-xs text-muted">{signatory.title}</span>
                        </div>
                      </TableCell>
                      <TableCell>
                      ...
                      <TableCell>
                        <div className="flex flex-col gap-1">
                          ...
                          {!signatory.email && !signatory.phone && (
                            <span className="text-xs text-muted italic">No contact info</span>
                          )}
                        </div>
                      </TableCell>
      ...
      <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <DialogContent className="sm:max-w-[400px]">
          <DialogHeader>
            <DialogTitle className="text-danger">Delete Signatory</DialogTitle>
            <DialogDescription>
