      ...
      <div className="p-4">
        ...
        <div className="mt-4 p-4 bg-surface dark:bg-background rounded-lg border border-dashed border-border dark:border-border">
          <div className="relative aspect-[2/1] max-w-md mx-auto">
            ...
            {/* Center Property */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-20 h-12 bg-primary/20 dark:bg-primary/30 border-2 border-primary rounded flex items-center justify-center">
              <span className="text-[10px] font-bold text-primary dark:text-primary-light">PROPERTY</span>
            </div>
          </div>
        </div>
      </div>
