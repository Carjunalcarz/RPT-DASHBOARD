  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button
          className="px-3 py-2 text-xs bg-surface dark:bg-muted/20 hover:bg-muted/5 dark:hover:bg-muted/30 border border-border dark:border-border rounded-lg shadow-sm transition-colors flex items-center gap-1.5 outline-none focus:ring-2 focus:ring-primary h-9 whitespace-nowrap"
