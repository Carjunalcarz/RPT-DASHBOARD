    ...
    <div id="print-document" className="print-faas-official">
        ...
        <div className="faas-border-inner">
          ...
          <div className="faas-row border-b">
            ...
            <div className="faas-col faas-col-6 p-0 flex flex-col">
              ...
              <div className="faas-sketch-area flex-1 flex items-center justify-center relative p-4">
                ...
                <div className="absolute bottom-1 right-2 text-[5pt] italic text-muted">(Not necessarily drawn to scale)</div>
              </div>
            </div>
          </div>
          ...
          <table className="faas-table">
            <thead>
              ...
              <tr>
                <th className="text-center border-t border-border">Non-Fruit Bearing / Non Harvestable (Age)</th>
                <th className="text-center border-t border-border">Fruit Bearing / Harvestable (Age)</th>
              </tr>
            </thead>
            <tbody>
      ...
      <div className="faas-page faas-page-back">
        <div className="faas-border-inner">
          ...
          <div className="faas-row border-b bg-background">
            <div className="faas-col faas-col-3 border-r">
             ...
             <div className="flex justify-between items-start">
                ...
                <div className="flex-1 max-w-[45%]">
                   ...
                   <div className="flex gap-4 text-[7pt] mt-1 pl-4">
                      <div className="flex-1 text-center italic text-foreground font-bold">MUNICIPAL ASSESSOR</div>
                      <div className="w-24 text-center">Date</div>
                   </div>
                </div>
             </div>
