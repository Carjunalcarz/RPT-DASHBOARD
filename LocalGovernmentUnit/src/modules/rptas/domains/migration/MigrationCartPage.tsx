          ...
          {migrationResults && (
            <div className="bg-white dark:bg-slate-900 rounded-xl shadow-lg border border-slate-200 dark:border-slate-800 overflow-hidden animate-in slide-in-from-top-4 duration-500">
              <div className="p-4 bg-slate-50 dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 flex items-center justify-between">
                ...
                <button 
                  onClick={downloadLog}
                  className="px-3 py-1.5 text-white text-xs font-bold rounded-lg flex items-center gap-2 transition-colors hover:brightness-110 bg-primary"
                >
                  <Download size={14} />
                  DOWNLOAD FULL LOG
                </button>
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 shadow-xl border border-slate-200 dark:border-slate-800 sticky top-24">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <select 
                            className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-3 text-sm font-bold focus:ring-2 focus:ring-primary outline-none transition-all text-primary"
                          >
