    ...
    <div className="bg-white dark:bg-slate-900 rounded-lg shadow-sm border border-slate-200 dark:border-slate-800 p-3">
      <div className="flex flex-wrap gap-2">
        <button
          onClick={onAdd}
          disabled={isEditing}
          className="px-3 py-2 text-xs bg-primary hover:bg-primary-light dark:bg-primary/50 dark:hover:bg-primary text-white dark:text-white rounded-lg transition-colors flex items-center gap-2 font-medium disabled:bg-slate-300 dark:disabled:bg-slate-700 disabled:cursor-not-allowed"
        ...
        <button
          onClick={onRefresh}
          className="px-3 py-2 text-xs bg-primary hover:bg-primary-light dark:bg-primary/50 dark:hover:bg-primary text-white dark:text-white rounded-lg transition-colors flex items-center gap-2 font-medium"
