  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="mb-6">
      ...
      <div className="flex justify-end gap-3">
        ...
        <button
          type="submit"
          className="px-4 py-2 text-sm bg-primary hover:bg-primary-light dark:bg-primary/50 dark:hover:bg-primary text-white dark:text-white rounded-lg transition-colors font-medium"
        >
