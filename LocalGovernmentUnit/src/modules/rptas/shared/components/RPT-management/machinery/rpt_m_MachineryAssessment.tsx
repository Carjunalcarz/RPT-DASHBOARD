    ...
    <div className="bg-white dark:bg-slate-900 rounded-lg shadow-sm border border-slate-200 dark:border-slate-800" data-testid="machinery-assessment">
      ...
      <div className="bg-transparent border-b border-slate-200 dark:border-slate-700 px-3 py-2">
        <div className="flex flex-wrap gap-1">
          ...
          <button onClick={handleSave} disabled={!isLocalFormEnabled} className="px-3 py-1.5 text-xs bg-primary text-white dark:text-white hover:bg-primary-light rounded shadow-sm flex items-center gap-1.5 disabled:opacity-50">
            <Save size={14} /> Save
          </button>
