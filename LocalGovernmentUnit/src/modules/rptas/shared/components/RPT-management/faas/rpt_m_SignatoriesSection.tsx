                ...
                <>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <select
                      ...
                      disabled={!isEditing}
                      className="px-2 py-1.5 text-xs bg-white dark:bg-slate-700 border border-slate-300 dark:border-slate-600 rounded shadow-sm focus:outline-none focus:ring-1 focus:ring-primary/50 disabled:opacity-50"
                    >
