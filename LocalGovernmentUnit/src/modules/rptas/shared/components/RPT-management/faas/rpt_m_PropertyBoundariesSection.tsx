      ...
      <div className="p-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-3">
            ...
            {/* North */}
            <div className="flex items-center gap-3">
              <label className={`${labelClass} text-primary dark:text-primary/80 font-semibold`}>
        ...
        <div className="mt-4 p-4 bg-white dark:bg-slate-800 rounded-lg border border-dashed border-slate-300 dark:border-slate-600">
          <div className="relative aspect-[2/1] max-w-md mx-auto">
            {/* North Label */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 text-[10px] font-medium text-primary dark:text-primary/80 truncate max-w-[200px]" title={data.north}>
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-20 h-12 bg-primary/10 dark:bg-primary/10 border-2 border-primary/50 rounded flex items-center justify-center">
              <span className="text-[10px] font-bold text-primary-light dark:text-primary/60">PROPERTY</span>
            </div>
          </div>
        </div>
      </div>
