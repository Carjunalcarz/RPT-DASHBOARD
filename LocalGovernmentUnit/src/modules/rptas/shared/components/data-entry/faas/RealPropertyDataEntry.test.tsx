...
vi.mock('@/modules/rptas/shared/services/faasService', () => ({
    ...
    getDistinctTaxBegYears: vi.fn().mockResolvedValue({ success: true, data: [] }),
}));

vi.mock('@/modules/rptas/shared/services/transactionValidation', () => ({
  validateTransactionStart: () => ({ isValid: true, errors: [] }),
  validateTransactionSave: () => ({ isValid: true, errors: [] }),
}));
