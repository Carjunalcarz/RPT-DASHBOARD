      ...
      <div className="mb-4">
        ...
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 px-3 py-2 text-sm bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50 dark:focus:ring-blue-600 text-slate-900 dark:text-slate-100"
          />
          <button
            onClick={() => onPinSearch(pin)}
            className="px-4 py-2 text-sm bg-primary hover:bg-primary-light dark:bg-primary/50 dark:hover:bg-primary text-white dark:text-white rounded-lg transition-colors flex items-center gap-2 font-medium"
          >
            <Search size={16} />
            Search
          </button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        <div>
          ...
          <select
            ...
            className="w-full px-3 py-2 text-sm bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50 dark:focus:ring-blue-600 text-slate-900 dark:text-slate-100"
          >
