      ...
      <div className="space-y-6">
        ...
        <div className="bg-slate-50 dark:bg-slate-800/50 rounded-lg p-4">
          ...
          <textarea
            ...
            className="w-full px-3 py-2 text-sm bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50 text-slate-900 dark:text-slate-100 disabled:opacity-70 disabled:cursor-not-allowed resize-none"
