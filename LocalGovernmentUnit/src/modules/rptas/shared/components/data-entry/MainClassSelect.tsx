...
const MainClassSelect: React.FC<Props> = ({
  label,
  value,
  options,
  onValueChange,
  ...
  const optionByCode = useMemo(() => {
    const map = new Map<string, MainClassOption>();
  ...
  return (
    <div ref={wrapperRef} className="relative">
      ...
      <input
        ...
        data-testid={dataTestId || 'main-class-input'}
      ...
      {open && anchorRect
        ? createPortal(
            <div
              ...
              data-testid="main-class-options"
            >
              {filtered.length === 0 ? (
                ...
                filtered.map((o) => (
                  <button
                    ...
                    data-testid={`main-class-option-${o.code}`}
                  >
...
export default MainClassSelect;
