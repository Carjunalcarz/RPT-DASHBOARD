...
import type { AssessmentRow } from '../../../domains/RPT-management/rpt_m_types';
    ...
    <div id="print-document" className="print-faas-official">
      ...
      <div className="faas-page faas-page-front">
        <div className="faas-border-inner">
          ...
          <div className="faas-watermark">
            <img src="/assessor-logo.png" alt="" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = 'none'; }} />
          </div>
          {/* Header Strip Removed */}

          {/* Form Header */}
          <div className="faas-header bg-white text-black print:bg-white print:text-black" style={{ position: 'relative' }}>
            <img
              src="/assessor-logo.png"
              alt="LGU Logo"
              style={{ position: 'absolute', left: '8px', top: '50%', transform: 'translateY(-50%)', height: '40px', width: '40px', objectFit: 'contain' }}
          ...
          <table className="faas-table">
            ...
            <tbody>
              ...
              <tr className="faas-table-total">
                ...
                <td className="text-right font-bold text-primary-light">{formatNumber(summary.totalAssessedValue)}</td>
              </tr>
            </tbody>
          </table>
