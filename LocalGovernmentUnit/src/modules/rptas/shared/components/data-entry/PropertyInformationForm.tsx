    ...
    <form onSubmit={handleSubmit(onSubmit)} className="mb-6">
      ...
      <div className="flex justify-end gap-3">
        ...
        <button
          ...
          className="px-4 py-2 text-sm bg-primary hover:bg-primary-light dark:bg-primary/5 dark:hover:bg-primary text-white dark:text-white rounded-lg transition-colors font-medium flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
        >
