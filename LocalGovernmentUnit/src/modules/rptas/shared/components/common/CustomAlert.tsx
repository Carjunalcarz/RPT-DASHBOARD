      ...
      <DialogContent className="sm:max-w-[425px]" data-testid="custom-alert-dialog">
        ...
        <DialogFooter>
          {isConfirm ? (
            ...
            <button
              onClick={() => closeAlert()}
              className="inline-flex h-10 items-center justify-center rounded-md bg-primary px-4 py-2 text-sm font-medium text-white dark:text-white ring-offset-background transition-colors hover:bg-primary-light focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50"
