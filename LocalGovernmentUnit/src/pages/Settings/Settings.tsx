      ...
      <div className="space-y-6">
          ...
          <div className="divide-y divide-border">
            ...
            <div className="flex items-center justify-between p-5">
              ...
              <div className="flex gap-2">
                <button
                  onClick={() => setNavigationUI("desktop")}
                  className={cn(
                  ...
                  title="Desktop Mode - Taskbar at bottom"
                >
                  <LayoutDashboard className="w-4 h-4" />
                  <span>Desktop</span>
                </button>
                <button
                  onClick={() => setNavigationUI("sidebar")}
                  className={cn(
                    "flex items-center gap-2 px-3 py-2 rounded-lg border text-sm transition-colors",
                  ...
                  title="Sidebar Mode - Collapsible sidebar"
                >
            ...
            {/* Dock Style - Only show in desktop mode */}
            {navigationUI === "desktop" && (
              <div className="flex items-center justify-between p-5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted mt-0.5">
                      Adjust the size of the bottom dock icons
                    </p>
                  </div>
                </div>
                <div className="flex gap-2">
                  <button
                    onClick={() => setDockStyle("compact")}
                    className={cn(
                      "flex items-center gap-2 px-3 py-2 rounded-lg border text-sm transition-colors",
                      dockStyle === "compact"
                        ? "border-success bg-success/15 text-success"
                    ...
                    title="Compact - Smaller icons, more space"
                  >
                    <LayoutGrid className="w-4 h-4" />
                    <span>S</span>
                  </button>
                  <button
                    onClick={() => setDockStyle("comfortable")}
                    className={cn(
                      "flex items-center gap-2 px-3 py-2 rounded-lg border text-sm transition-colors",
                    ...
                    title="Comfortable - Balanced size"
                  >
                    <LayoutGrid className="w-4 h-4" />
                    <span>M</span>
                  </button>
                  <button
                    onClick={() => setDockStyle("expanded")}
                    className={cn(
                      "flex items-center gap-2 px-3 py-2 rounded-lg border text-sm transition-colors",
                      dockStyle === "expanded"
                        ? "border-success bg-success/15 text-success"
                    ...
                    title="Expanded - Larger icons, easier to click"
                  >
                    <LayoutGrid className="w-4 h-4" />
                    <span>L</span>
                  </button>
        ...
        <section className="bg-surface border border-border rounded-2xl overflow-hidden">
          ...
          <div className="divide-y divide-border">
            <div className="flex items-center justify-between p-5">
              <div className="flex items-center gap-3">
                <div className="flex items-center justify-center w-10 h-10 rounded-lg bg-background text-muted">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted mt-0.5">
                    Open command palette to search modules
                  </p>
                </div>
              </div>
              <kbd className="flex items-center gap-1 rounded-lg border border-border bg-background px-3 py-1.5 text-xs font-mono text-foreground">
                Ctrl <span className="text-muted">+</span> K
              </kbd>
            </div>
            <div className="flex items-center justify-between p-5">
              <div className="flex items-center gap-3">
              ...
              <kbd className="flex items-center gap-1 rounded-lg border border-border bg-background px-3 py-1.5 text-xs font-mono text-foreground">
                Ctrl <span className="text-muted">+</span> W
              </kbd>
            </div>
            <div className="flex items-center justify-between p-5">
              <div className="flex items-center gap-3">
              ...
              <kbd className="flex items-center gap-1 rounded-lg border border-border bg-background px-3 py-1.5 text-xs font-mono text-foreground">
                Ctrl <span className="text-muted">+</span> Tab
              </kbd>
            </div>
            <div className="flex items-center justify-between p-5">
              <div className="flex items-center gap-3">
              ...
              <kbd className="rounded-lg border border-border bg-background px-3 py-1.5 text-xs font-mono text-foreground">
                F11
              </kbd>
            </div>
            <div className="flex items-center justify-between p-5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted mt-0.5">
                    Expand or collapse the sidebar (in sidebar mode)
                  </p>
                </div>
              </div>
              <kbd className="rounded-lg border border-border bg-background px-3 py-1.5 text-xs font-mono text-foreground">
